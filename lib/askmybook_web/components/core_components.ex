defmodule AskmybookWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(AskmybookWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(AskmybookWeb.Gettext, "errors", msg, opts)
    end
  end
